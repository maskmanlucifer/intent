...
const CompletedTodoList = () => {
  ...
  return (
    <div className="completed-todo-list">
      {contextHolder}
      {completedTodos.length > 0 && <div className="completed-todo-items-groups">
        {completedTodos.length > 0 &&  (<Popconfirm
        ...
        {completedTodos.length > 0 && Object.keys(groupedTodos).map((folder) => {
      ...
      {completedTodos.length === 0 && (
          <div className="no-completed-todos">
            <Empty description="No completed todos available" image={Empty.PRESENTED_IMAGE_SIMPLE} />
          </div>
        )}
    </div>
  );
