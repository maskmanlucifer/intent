...
class DBHelper {
    ...
    async getTodos() {
        ...
        const transaction = this.db.transaction(DB_CONFIG.stores.todos.name, 'readonly');
    ...
    async putLink(link: TLink) {
        ...
        const transaction = this.db.transaction(DB_CONFIG.stores.linkboard.name, 'readwrite');
    ...
    async addCategory(category: Category) {
        ...
        const transaction = this.db.transaction(DB_CONFIG.stores.categories.name, 'readwrite');
